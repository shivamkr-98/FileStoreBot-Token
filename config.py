...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "1002350351783"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "1002139172257"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6005627579").split()):
        ADMINS.append(int(x))
except ValueError:
